...
Aware is a minimal **Assess** prototype for telemetry-based root-cause analysis. It combines a Parser agent, an Executor agent, dynamic analysis sub-agents, and a small web UI to turn an incident question into a validated BuildSpec and an execution report.
